# reactjs-router-2-kimz-forlearning
...
1. Clone the repository:
   ```bash
   git clone https://github.com/olahasan/reactjs-router-2-kimz-forlearning.git
...
- Solution URL: [here](https://github.com/olahasan/reactjs-router-2-kimz-forlearning)

- Live Site URL: [here](https://reactjs-router-2-kimz-forlearning.surge.sh/)  OR  [here](https://reactjs-router-2-kimz-forlearning.netlify.app/)
